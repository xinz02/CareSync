                                          ...
                                          onChanged: (String? newValue) {
                                            setState(() {
                                              ...
                                              if (_selectedOption == 'Dine In') {
                                                _selectedTime = null;
                                              } else if (_selectedOption == 'Pickup') {
                                                _selectedTime = 'ASAP'; // Set _selectedTime to 'ASAP' if Pickup is selected
                                              }
                                            });
                                          },
                                                  ...
                                                  return DropdownMenuItem<String>(
                                                    ...
                                                    child: Text(
                                                      ...
                                                      style: TextStyle(
                                                        ...
                                                        // Make ASAP bold
                                                        color: value == 'ASAP' ? Colors.black : null,
                                                        ),
                                                      ),
                                                  );
                                                }).toList(),
                              ...
                              Card(
                                ...
                                child: Column(
                                  children: List.generate(_cartItems.length, (index) {
                                    ...
                                    final isLastItem = index == _cartItems.length - 1;
                                    return Column(
                                      children: [
                                        ListTile(
                            ...
                            children: [
                              ...
                              ElevatedButton(
                                ...
                                style: ElevatedButton.styleFrom(
                                  ...
                                  backgroundColor: Color.fromARGB(255, 195, 133, 134),
